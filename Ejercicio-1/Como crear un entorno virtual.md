...
## 📦 Paso 4 — Instalar NumPy en el entorno virtual

Una vez que el entorno virtual está **activado**, instala NumPy con el siguiente comando:

```bash
pip install numpy
```

🔹 NumPy es una librería fundamental para cálculo numérico y manejo de arreglos en Python.
...
Si aparece la información del paquete, NumPy se instaló correctamente dentro del entorno virtual.

---

## ▶️ Paso 5 — Usar el entorno virtual
